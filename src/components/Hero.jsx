...
import SergelMedicine from '../assets/sergelMedicine.png'
...
<div class="relative overflow-hidden before:absolute before:top-0 before:start-1/2 before:bg-[url('https://preline.co/assets/svg/examples/polygon-bg-element.svg')] before:bg-no-repeat before:bg-top before:bg-cover before:w-full before:h-full before:-z-[1] before:transform before:-translate-x-1/2 dark:before:bg-[url('https://preline.co/assets/svg/examples/polygon-bg-element-dark.svg')]">
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-10">
    ...
    <div class=" max-w-5xl text-center mx-auto">
      ...
      CHOOSE BRAND-NAME 
        <span class="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent pl-3">Sergel</span>
      </h1>
    </div>
 

    <div class="mt-5 max-w-3xl text-center mx-auto">
      <p class="text-lg text-gray-600 dark:text-gray-400">The "Blue Pill": #1 Prescribed Branded Medication of Its Class Since 2001[1]</p>
    </div>

   <div className='flex justify-center items-center'>
    <img src={SergelMedicine} className='w-80'/>
   </div>
